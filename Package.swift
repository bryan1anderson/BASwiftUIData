...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "BAUtilities", url: "https://github.com/bryan1anderson/BAUtilities", .branch("master")),
    ...
    targets: [
        ...
        .target(
            name: "BASwiftUIData",
            dependencies: ["PhoneNumberKit", "Alamofire", "Nuke", "Marshal", "BAUtilities", "SwiftyJSON", "Reachability", "FetchImage"]),
        .testTarget(
